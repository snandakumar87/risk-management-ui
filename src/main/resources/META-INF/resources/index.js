if (!!window.EventSource) {
    ...
    eventSource.onmessage = function(event) {
        ...
        var row = '<tr><td>' + data.correlationId + '</td><td>' + data.subProcessCorrelationId + '</td><td>' + data.entityType + '</td><td>' + data.entityId  ;
            ...
            row+='<td><button class="btn btn-icon btn-primary" type="button" id="ajaxSubmit" onclick="checkout(\x22'+data.correlationId+'\x22)"><span class="btn-inner--icon">Details<i class="ni ni-bold-right"></i></span></button>';
